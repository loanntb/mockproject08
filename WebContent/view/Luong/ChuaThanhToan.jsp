...
<div id="main">
         ...
         <li class="active">Danh sách lương chưa thanh toán</li>
      </ol>
      <div class="col-xs-12">
         <form id="post_form" method="post" action="" role="form" >
          ...
          <script type="text/javascript" class="init">
                   ...
                   <% ArrayList<Luong> list = (ArrayList<Luong>)request.getAttribute("list");
                    ...
                    %>
                     <tr>
                        ...
                        <td style="text-align: center"><button class="btn btn-danger" onclick="toggleOff()">Chưa thanh toán</button></td>
                        <td>
                        <a href="ThanhToanServlet?maLuong=<%=list.get(i).getMaLuong()%>&maNhanVien=<%= list.get(i).getMaNV() %>">
                       	 <i class="fa fa-edit text-success" data-toggle="tooltip" data-placement="top" title="Thanh toán lương nhân viên"></i>
                        </a>
                        </td>
                     </tr>
                     <% 
               ...
               <p class="note-items"><i class="fa fa-edit text-success"></i> Thanh toán lương nhân viên.</p>
            </div>
         </form>
      </div>
         </div>
